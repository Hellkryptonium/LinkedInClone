import { getAboutUser, getAllUser, createPost } from '@/config/redux/action/authAction';
import { deletePost, getAllComments, getAllPost, incrementLike, postComment } from '@/config/redux/action/postAction';
            ...
            <div className={styles.scrollComponent}>
              ...
              <div className={styles.wrapper}>
                <div className={styles.createPostContainer}>
                  <img className={styles.userProfile} width={200} src={`${BASE_URL}/${authState.user.userId.profilePicture}`} alt=""></img>
                  <textarea onChange={(e) =>
                ...
                <div className={styles.postsContiner}>
                        ...
                        {postState.comments.map((comment, index) => {
                          return (
                            <div className={styles.singleComment} key={commentText._id}> 
                              <img src={`${BASE_URL}/${comment.userId.profilePicture}`} alt=""></img>
                              <div>
